    ...
    <div className="min-h-screen bg-blt-white">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-8">
          <Link 
            to="/" 
            className="inline-flex items-center text-blt-dark hover:text-blt-neon transition-colors mb-6"
          >
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 space-y-8">
          ...
          {/* Section 1 */}
          <section>
            <h2 className="text-2xl font-bold text-blt-dark mb-4">
          ...
          {/* Contact Section */}
          <section className="bg-blt-gray rounded-xl p-6 mt-8">
            <h2 className="text-2xl font-bold text-blt-dark mb-4 flex items-center">
              <Mail className="w-6 h-6 mr-3 text-blt-neon" />
              Contacto
            </h2>
            <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <a 
              ...
              className="inline-flex items-center bg-blt-neon text-blt-dark px-6 py-3 rounded-lg font-semibold hover:bg-opacity-90 transition-all transform hover:scale-105"
            >
        ...
        <div className="text-center mt-12 pt-8 border-t border-gray-200">
          <p className="text-gray-600">
            &copy; 2024 Bros Lab Tech. Todos los derechos reservados.
          </p>
        </div>
      </div>
    </div>
